...
|------|--------|-------|-----|-----|-----------|-------------|
| **OE Kraken** | v9.1 | 20M-4B tokens | 96-99.5% | 38 MB - 2.1 GB | 1.6-41ms | Single mmap inverted index |
| **OE Leviathan** | v9.3 | 5B-50B+ tokens | 90-95% | 3-12 GB | 20-92ms | Multi-segment (2.5B per segment) |

**OE Kraken** is the flagship. v9.1 mmap inverted index achieves the highest recall at any scale up to 4B tokens in minimal RAM. Runs on anything from a Raspberry Pi to a workstation.
...
In-memory BM25 engine. 94-96% R@8 from 1B to 20B, but requires 3-60GB RAM. Superseded by v9.1 multi-segment for most use cases.
